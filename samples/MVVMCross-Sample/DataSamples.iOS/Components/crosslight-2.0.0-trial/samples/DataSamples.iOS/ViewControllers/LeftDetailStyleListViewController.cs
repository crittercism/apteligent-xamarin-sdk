...
{
    [Register("LeftDetailListViewController")]
    [ImportBinding(typeof(CategoryListBindingProvider))]
    [RegisterNavigation("LeftDetailCellStyle")]
    public class LeftDetailListViewController : UITableViewController<CategoryListViewModel>
    {
        public override TableViewCellStyle CellStyle
        {
            get
            {
                return TableViewCellStyle.LeftDetail;
            }
        }
    }
}
