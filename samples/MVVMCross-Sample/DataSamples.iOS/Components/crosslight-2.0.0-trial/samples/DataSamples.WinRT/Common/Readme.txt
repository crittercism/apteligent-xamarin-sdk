...
The files originally in Common has been reorganized into respective folder structure that
matches the purpose of each files group in a more maintainable way.

The recommended project organization is as follows:
- Assets
	- Data
	- Images
	- Styles
...
The only files that supposed to be in the root folder are:
- App.xaml
- Pfx, manifest and other packaging related files
